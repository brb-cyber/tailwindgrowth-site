...
const STORAGE_KEY = 'tg_abc_unlocked';
...
const PROMPT_CONTENT = `Perform a spelling and grammar check of the text provided. Use Australian English conventions throughout.
...
- Check for: spelling errors, grammar mistakes, missing articles, punctuation issues, parallel structure, capitalisation, and hyphenation of compound modifiers
- Do NOT change the author's voice, tone, or deliberate stylistic choices (e.g. intentional slang, colloquialisms, informal contractions used for effect)
- If there are no errors, say so clearly and still provide the clean text`;

export default function AbcGate() {
              ...
              {!unlocked ? (
                ...
                <div>
                  ...
                  <ol style={{ paddingLeft: '1.25rem', lineHeight: 1.8, color: 'var(--ink-700)', marginBottom: '1.5rem' }}>
                    ...
                    <li style={{ marginBottom: '0.75rem' }}>
                      Create a new file named <code style={INLINE_CODE}>abc.md</code>
                    </li>
                  ...
                  <pre style={CODE_BLOCK}>{`/abc\n[paste your text here]`}</pre>

                  <p style={{ color: 'var(--ink-500)', lineHeight: 1.7 }}>
                    Type <code style={INLINE_CODE}>/abc</code> then paste your text in the same message. Claude will return the annotated corrections first, then a clean corrected version ready to copy and paste.
                  </p>
                </div>
              )}
            </div>
